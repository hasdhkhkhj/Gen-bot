    ...
    if (err) {
      ...
      fs.readdir('premium', (err, pstockFiles) => {
        if (err) {
          ...
          <html>
          <head>
          <title>Yokiro's Gen Bot</title>
          <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css">
          <link rel="icon" href="https://media.discordapp.net/attachments/1189860785367818330/1202269883807830086/yokiro_rounder.png?ex=65ccd815&is=65ba6315&hm=ac7b18d2d60ce08a47a4301518cb5f1ca61dc8d0a303a2ce0226a100e34bc4c4&=&format=webp&quality=lossless&width=417&height=417" type="image/jpg">
              ...
              <ul>
                  <li>
                      <a href="#">
                          ...
                          <span class="title">Yokiro's Gen Bot</span>
                      </a>
                  </li>
...
<div class="floating-heart">
		...
		<div class="tooltip">Made by Yokiro</div>
	  </div>
...
<div class="features">
    <h2>Features</h2>
    <ul>
      <li><strong>Automated Giveaways:</strong> Automates the entire giveaway process, from start to finish. Simply set up the giveaway parameters, and Gen Bot will handle the rest, including participant entry tracking, winner selection, and prize distribution.</li>
      <li><strong>Safety and Security:</strong> Ensures a safe and secure giveaway experience. The bot employs various anti-cheat measures to prevent fraudulent entries, ensuring fairness for all participants.</li>
      <li><strong>Easy Configuration:</strong> Setting up the Gen Bot is a breeze. The bot provides an intuitive and user-friendly setup process, guiding you through each step to configure the giveaway settings according to your preferences.</li>
    </ul>
  </div>
